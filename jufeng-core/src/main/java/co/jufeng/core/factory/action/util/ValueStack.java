...
public interface ValueStack {
    ...
    public static final String VALUE_STACK = "co.jufeng.core.factory.action.util.ValueStack";

    public static final String REPORT_ERRORS_ON_NO_PROP = "co.jufeng.core.factory.action.util.ValueStack.ReportErrorsOnNoProp";
