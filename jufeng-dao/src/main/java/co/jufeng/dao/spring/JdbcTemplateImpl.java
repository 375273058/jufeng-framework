...
public class JdbcTemplateImpl extends
		org.springframework.jdbc.core.JdbcTemplate implements JdbcTemplate {
	...
	public void beginTranstaion() {
		TransactionStatus tmp = platformTransactionManager
