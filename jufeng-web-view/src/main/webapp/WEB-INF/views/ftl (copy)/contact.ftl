...
<!--header-->
	...
	<h1 class="intro">It's art if it can't be explained. It's <span>fashion</span> if no one asks for an <span>explanation.</span> 
	It's <span class="hue">design</span> if it doesn't need explanation. - Wouter Stokkel</h1>
        ...
        <!-- // End Google Map -->
			...
			<div class="pad10"></div>
				<div class="row">
					<div class="span4">
					<h3>Do you need a website, have a question or comment? Please feel free to send us an email or fill in our handy contact form. We aim to reply within 24 hours.</h3>
				...
				<h5>
					E: <a href="mailto:#">name@example.com</a><br>
					P: +44 020 2345 1987
				</h5>
			</div>
