...
<!--header-->
	...
	<!--//welcome-->
        ...
        <div class="span3">
          <div class="tile">
            <img class="tile-image big-illustration" alt="" src="img/illustrations/map.png" />
        ...
        <div class="span3">
          <div class="tile tile-hot">
            <img class="tile-image big-illustration" alt="" src="img/illustrations/share.png" />
		...
		<div class="row">	
				...
				<div class="span4">
			<h1>Recent Work</h1>
			<h4>Lorem ipsum dolor sit amet, rebum putant recusabo in ius, pri simul tempor ne, his ei summo virtute efficiantur.</h4>
	...
	<div class="container"><div class="row">
		<!--column 1-->
			<div class="span3">
					...
					<ul>
						<li>
						<p>Sanso tincidunt laoreet est, in trist ique <a href="#">sapien consequat</a>.
				...
				<div class="span3">
					...
					<p>Pellentesque tincidunt laoreet est, in tristique <a href="#">sapien consequat</a>.
						Lorem ipsum dolor sit amet, rebum putant recus.
					</p>
					<p>
...
//<![CDATA[
/*************************************************************
	add your id - find it here - http://idgettr.com/
**************************************************************/
...
//<![CDATA[
     ...
     $("#slider_home") .carouFredSel({
        width : "100%", height : "auto",
         circular : false, responsive : true,
